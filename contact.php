...
<div class="col-md-4">
 ...
 <div class="contact-info">
   <div>
          <img src="img/th (1).jpg" width="25" height="25">
    <a href="tel:111258259">111-258-259</a>
          </div>
    <br>
       <div>
          <img src="img/th (2).jpg" width="25" height="25">
           <a href="mailto:#">clucks@cluckys.pk</a>
             </div>
          <br>
     <div>
   <img src="img/th (3).jpg" width="25" height="25">
...
if (isset($_POST['submit'])) {
  ...
  $onmind=$_POST['contact-message'];

  $enter=$conn->prepare("INSERT INTO Contact (Name,email,phone,onmind) VALUES ('$name','$email','$phone','$onmind')");
  if ($enter->execute()) {
  ?>
  <script>
